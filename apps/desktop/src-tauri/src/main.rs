...
fn main() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            endgame_service::import_endgame_cbl_batch,
            ...
            endgame_service::move_endgame_libraries,
            endgame_service::reorder_endgame_library,
            ...
            endgame_service::endgame_move_feedback,
