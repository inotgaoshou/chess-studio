...
class DesktopPlatform implements ChessPlatform {
  ...
  confirmRecognizedMove(fen: string, iccs: string) { return invoke<Partial<BoardState>>("confirm_recognized_move", { fen, iccs }); }
