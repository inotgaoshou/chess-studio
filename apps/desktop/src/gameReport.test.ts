...
const dataset: GameReportDatasetDto = {
  ...
  positions: [
    ...
    { fen: "after-red", sideToMove: "黑方", ply: 1, phase: "opening", scoreCp: -500, masterStyleHints: [{
      sampleId: "sample-1",
      ...
      bestMove: "h2e2",
      bestScoreCp: 36,
      theoryCards: [{ id: 1, title: "布局阶段先协调强子", summary: "开局应优先出动强子。" }],
    }], move: { nodeId: "red", notation: "炮二平五", movedBy: "红方" } },
