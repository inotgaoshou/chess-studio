...
export default function App() {
  ...
  const [linkConfirmingMove, setLinkConfirmingMove] = useState(false);
      ...
      <div className="actionbar">
        ...
        <div className="skin-menu">
          ...
          {skinMenuOpen && <section className="skin-menu-popup" aria-label="棋盘皮肤设置" onPointerLeave={() => setSkinHoverPreview(undefined)}>
            ...
            <div className="skin-menu-featured"><span>默认整套</span><button className={activeBoardSkin === "qingxin-zhuyun" && activePieceSkin === "qingxin-zhuyun" ? "active" : ""} onPointerEnter={() => setSkinHoverPreview({ boardSkin: "qingxin-zhuyun", pieceSkin: "qingxin-zhuyun" })} onClick={() => void updateBoardSkin({ boardSkin: "qingxin-zhuyun", pieceSkin: "qingxin-zhuyun" })}><i className="skin-choice-preview board qingxin-zhuyun"/><b>棋盘</b></button><button className={activeBoardSkin === "qingxin-zhuyun" && activePieceSkin === "qingxin-zhuyun" ? "active" : ""} onPointerEnter={() => setSkinHoverPreview({ boardSkin: "qingxin-zhuyun", pieceSkin: "qingxin-zhuyun" })} onClick={() => void updateBoardSkin({ boardSkin: "qingxin-zhuyun", pieceSkin: "qingxin-zhuyun" })}><i className="skin-choice-preview piece qingxin-zhuyun">将</i><b>棋子</b></button></div>
