...
export function ReferencePositionPanel({ fen, enabled, query, onPreview, onAdd, onOpenExplorer }: Props) {
  ...
  return <section className="reference-position-panel" aria-label="当前局面实战库">
    <header>
      <span><BookOpen size={14}/><strong>实战库</strong><small>当前局面</small></span>
      <nav>
