...
const library: TheoryLibraryDto = {
  ...
  lessons: [
    ...
    { id: 2, phase: "opening", courseName: "专1原创棋理", title: "开局协调", sourcePath: "bundled", fingerprint: "u10", transcriptionStatus: "complete", scannedAt: "2026-08-14T00:00:00Z" },
  ],
  cards: [
    ...
    { id: 2, externalId: "u10-opening-coordinate", lessonId: 2, phase: "opening", title: "先出动强子", summary: "开局优先协调马炮。", appliesWhen: "开局阶段。", risk: "有战术先算。", reviewStatus: "approved", courseName: "专1原创棋理", lessonTitle: "开局协调", tags: ["开局"], engineCorrelations: [], origin: "bundled", version: 1, userModified: false, matchPenalty: 0, needsRecheck: false },
  ],
};
