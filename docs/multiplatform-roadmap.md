# Xiangqi Studio / 棋析 Roadmap Checklist
...
- [x] 独立移动残局 App：`apps/endgame-training`，Capacitor iOS/Android，“棋析”，CBL 残局训练、本地 SQLite、移动 Pikafish、皮肤与自由拆棋。
...
- [ ] 棋析移动端：残局训练专项，打磨逻辑残棋、离线训练、Pikafish 拆棋。
